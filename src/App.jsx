...
const GALLERY_PHOTOS = [
  ...
  { img: gallery10, cap: "Adriano Martins", sub: "BJJ College — São Paulo" },
  { img: gallery11, cap: "Pablo Rosales", sub: "BJJ College — São Paulo" },
  { img: gallery12, cap: "Diogo Reis", sub: "Champion ADCC · Champion One Championship" },
  { img: gallery13, cap: "Nicolas Renier", sub: "Fondateur NRFight — BJJ College" },
  { img: gallery14, cap: "Nicolas Renier & Diogo Reis", sub: "BJJ College — São Paulo" },
  { img: gallery15, cap: "Cours Grappling — No-Gi", sub: "BJJ College by Melqui Galvão" },
  { img: gallery16, cap: "Nicolas Renier · Poivron · Melqui Galvão", sub: "BJJ College — São Paulo" },
  { img: gallery17, cap: "Cours Grappling — No-Gi", sub: "BJJ College by Melqui Galvão" },
  { img: gallery18, cap: "Adriano Martins", sub: "BJJ College — São Paulo" },
  { img: gallery19, cap: "Pablo Rosales · Mika Galvão · Pantoja", sub: "BJJ College — São Paulo" },
  { img: gallery20, cap: "Lucas Yan · Isaque Lima", sub: "BJJ College — São Paulo" },
  { img: gallery21, cap: "Gabriel", sub: "BJJ College — São Paulo" },
  { img: gallery22, cap: "Nathanaël Jackson", sub: "BJJ College — São Paulo" },
  { img: gallery23, cap: "Melqui Galvão", sub: "BJJ College by Melqui Galvão" },
  { img: gallery24, cap: "Immersion Brésil", sub: "BJJ College — São Paulo" },
  { img: gallery25, cap: "Claudio Ribeiro", sub: "BJJ College — São Paulo" },
  { img: gallery26, cap: "Immersion Brésil", sub: "BJJ College — São Paulo" },
  { img: gallery27, cap: "Alex Sodré", sub: "BJJ College — São Paulo" },
  { img: gallery28, cap: "Poivron", sub: "BJJ College — São Paulo" },
  { img: gallery29, cap: "Pantoja", sub: "BJJ College — São Paulo" },
  { img: gallery30, cap: "Isaque Lima", sub: "BJJ College — São Paulo" },
  { img: gallery31, cap: "Immersion Brésil", sub: "BJJ College — São Paulo" },
  { img: gallery32, cap: "Nathanaël Jackson", sub: "BJJ College — São Paulo" },
  { img: gallery33, cap: "Arthur Sousa", sub: "BJJ College — São Paulo" },
  { img: gallery34, cap: "Zangado", sub: "BJJ College — São Paulo" },
  { img: gallery35, cap: "Caleb Henrique", sub: "BJJ College — São Paulo" },
  { img: gallery36, cap: "Zangado", sub: "BJJ College — São Paulo" },
  { img: gallery37, cap: "Pédro Henrique Rangel", sub: "BJJ College — São Paulo" },
  { img: gallery38, cap: "Lívia Barassine", sub: "BJJ College — São Paulo" },
  { img: gallery39, cap: "Vinicius Dilan", sub: "BJJ College — São Paulo" },
  { img: gallery40, cap: "Immersion Brésil", sub: "BJJ College — São Paulo" },
  { img: gallery41, cap: "Arthur Sousa · Alex Sodré", sub: "BJJ College — São Paulo" },
];

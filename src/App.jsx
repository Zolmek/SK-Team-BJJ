...
function InscriptionStrip() {
  ...
  const handleSubmit = async () => {
    ...
    setSending(true);
    const msg = encodeURIComponent(`Bonjour SK TEAM JJB ! Je souhaite réserver ma séance.\nNom : ${nom}\nTél : ${tel}`);
    ...
    <div className="inscription-strip">
      <div className="inscription-inner">
        <div className="inscription-text">
          ...
          <p>Première séance à 10€ · Clamart (92140)<br />Kids, Ados, Adultes, Masters</p>
          <div style={{ color: "#FFD700", fontFamily: "var(--fc)", fontSize: 11, marginTop: 8 }}>Places limitées — Inscriptions ouvertes</div>
        </div>
        {sent ? (
...
export default function App() {
  ...
  useEffect(() => {
    ...
    setMeta("description", "SK TEAM JJB — Club de Brazilian Jiu-Jitsu, Grappling et Self-Défense à Clamart (92140). Ceinture noire 1er Dan IBJJF, affilié FFJDA et CFJJB. Première séance à 10€.");
    setMeta("robots", "index, follow");
    setMeta("og:type", "website", true);
    setMeta("og:title", "SK TEAM JJB — BJJ Clamart", true);
    setMeta("og:description", "Club BJJ à Clamart. Première séance à 10€ !", true);
  ...
  const NAV_MORE = useMemo(() => [
    ...
    { id: "reglement", l: "Règlement" }, { id: "avis", l: "Avis" },
  ], []);
  ...
  const CARDS = useMemo(() => [
    ...
    { id: "coach", n: "02", icon: "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2 M12 11a4 4 0 100-8 4 4 0 000 8z", t: "Le Coach", d: "Karim Sadat, Ceinture Noire 1er Dan IBJJF, 13 ans de pratique, 2 000+ heures d'enseignement. CAF JJB France Judo." },
    ...
    { id: "horaires", n: "04", icon: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z M12 6v6l4 2", t: "Horaires & Tarifs", d: "Lundi et Mercredi 19h30–20h30. Première séance à 10€. Abonnements à partir de 200€/an." },
    ...
    { id: "contact", n: "11", icon: "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z", t: "Réserve ta séance", d: "Première séance à 10€, sans engagement. Venez découvrir le BJJ à Clamart." },
  ], []);
  ...
  return (
    <>
      ...
      <section id="hero" style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", overflow: "hidden", background: "#000" }}>
        <video autoPlay loop muted playsInline style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "contain", zIndex: 0 }}>
        ...
        <div className="hero-content">
          ...
          <p className="hero-desc">Club associatif affilié FFJDA et CFJJB, fondé à Clamart. Kids, Ados, Adultes et Masters — encadrés par un Ceinture Noire 1er Dan IBJJF.</p>
          ...
          <div className="hero-actions">
            ...
            <button className="btn-ghost-white" onClick={() => open("horaires")}>Voir les tarifs</button>
          </div>
        </div>
      ...
      <section className="home-section">
        <div className="home-section-inner">
          ...
          <div className="cards-grid">
            {CARDS.map(c => (
              <button key={c.id + c.n} className="card" onClick={() => open(c.id)} onMouseEnter={() => prefetchModal(c.id)}>
      ...
      <section className="about-strip">
        <div className="about-inner">
          <div className="about-left">
            ...
            <p>Ceinture Noire 1er Dan IBJJF, CAF JJB France Judo, CQP MAM en cours, 13+ ans de pratique, 2 000+ heures d'enseignement. Une pédagogie claire, progressive et bienveillante — du débutant au compétiteur. Immersion au Brésil chez Melqui Galvão, stage avec Joao Miyao. Fondateur de SK TEAM JJB, association loi 1901 à Clamart.</p>
      ...
      <section className="cta-strip">
        ...
        <div className="cta-strip-inner">
          <div>
            ...
            <p className="cta-strip-sub">Première séance à 10€, sans engagement. Venez découvrir le BJJ à Clamart dans une ambiance technique et bienveillante.</p>
          </div>
          <button className="btn-white" onClick={() => open("contact")}>Réserve ta séance</button>
        </div>
      </section>

      <div className="wa-wrap">
        <div className="wa-tooltip">WhatsApp</div>
        <a className="wa-btn" href="https://wa.me/33650054954?text=Bonjour%2C%20je%20souhaite%20réserver%20ma%20séance%20à%20SK%20TEAM%20JJB" target="_blank" rel="noopener noreferrer" aria-label="Contacter SK TEAM JJB sur WhatsApp">

...
export default function ModalCoach({ open, onClose }) {
  return (
    <ModalWrapper open={open} onClose={onClose} title="LE COACH">
      <img className="modal-hero-img" src={IMG.action} alt="Karim Sadat en action — coach BJJ Ceinture Noire IBJJF SK TEAM JJB" style={{objectPosition:"center 37.5%"}} loading="lazy"/>
